...
| 1.21 | 2026-09-16 | 服务信息页工具栏最近构建摘要按构建结果着色（成功绿底/失败红底）；Agent 二进制打包进镜像（远程安装/更新 Agent 无需挂载宿主机目录） | 6193128 | sha256:2a897c8bb77839441b1303fa0f4c2de87ef2103f372491a115e9bc82b9cabc5a |
| 1.22 | 2026-09-24 | 新增局域网聊天室入口：平台设置可配置聊天室地址，顶部用户区显示外链按钮（登录与 /api/auth/me 响应下发地址，未配置自动隐藏） | e51a788 | sha256:6d511aa8dd6e45a748db8c315403ef93de8c2f1c3b27b95df3d76da773de3722 |

> 下一版本：**1.23**（build 时自动递增并回填本表）
